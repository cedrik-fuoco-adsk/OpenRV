...
EXTERNALPROJECT_ADD(
  ...
  UPDATE_COMMAND ""
  CONFIGURE_COMMAND
    ${CMAKE_COMMAND} ${_configure_options} -DCMAKE_PREFIX_PATH=$ENV{QT_HOME}/lib/cmake -DPython_ROOT=${Python_ROOT} -Dimgui_INCLUDE_DIRS=${_imgui_include_dirs}
    -Dimgui_LIBRARY=${_imgui_library_file} -Dnanobind_ROOT=${RV_DEPS_BASE_DIR}/RV_DEPS_NANOBIND/install/nanobind -DRV_TARGET_WINDOWS=${RV_TARGET_WINDOWS}
