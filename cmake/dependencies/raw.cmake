...
# Force build from source: pre-built libraw packages may link against a shared lcms2
# DLL that isn't bundled.  Building from source uses OpenRV's own LCMS (lcms.dll).
# We need to remove lcms from pub-sub and use lcms2 in RV.
...
# List both targets naming because vcpkg creates libraw::raw and Conan creates libraw::libraw.
