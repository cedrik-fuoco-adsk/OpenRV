...
IF(RV_TARGET_WINDOWS)
  IF(CMAKE_BUILD_TYPE MATCHES "^Debug$")
    SET(_nanobind_python_executable
        # TODO Once its work in debug with conan
...
EXTERNALPROJECT_ADD(
  ...
  CONFIGURE_COMMAND ${CMAKE_COMMAND} ${_configure_options} -DPython_ROOT=${Python_ROOT} -DPython_EXECUTABLE=${_nanobind_python_executable}
