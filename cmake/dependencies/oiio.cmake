...
# against openjph. When openjph is found via Conan, the Conan generators folder is in
# CMAKE_PREFIX_PATH and Conan's CMakeDeps creates a non-namespaced 'openjph' target.
# When openjph is built from source, OpenJPH's own cmake config uses NAMESPACE openjph::,
# creating only 'openjph::openjph'. The $<TARGET_NAME_IF_EXISTS:openjph> then evaluates to
# nothing — no include dirs propagate and jpeg2000input.cpp fails to find openjph headers.
# Fix: write a Findopenjph.cmake shim that finds the config and creates the alias.
SET(_oiio_findopenjph_dir
    "${_build_dir}/cmake_modules"
)
FILE(MAKE_DIRECTORY "${_oiio_findopenjph_dir}")
FILE(
  WRITE "${_oiio_findopenjph_dir}/Findopenjph.cmake"
  "# Auto-generated by OpenRV cmake/dependencies/oiio.cmake.\n"
  "# Wraps the installed openjph cmake config and creates a non-namespaced 'openjph'\n"
  "# alias so OIIO's \$<TARGET_NAME_IF_EXISTS:openjph> resolves correctly.\n"
  "find_package(openjph CONFIG QUIET)\n"
  "if(openjph_FOUND AND TARGET openjph::openjph AND NOT TARGET openjph)\n"
  "  add_library(openjph ALIAS openjph::openjph)\n"
  "endif()\n"
)
STRING(REPLACE "\\" "/" _oiio_findopenjph_dir_clean "${_oiio_findopenjph_dir}")
STRING(APPEND _oiio_cache_content "list(PREPEND CMAKE_MODULE_PATH \"${_oiio_findopenjph_dir_clean}\")\n")
