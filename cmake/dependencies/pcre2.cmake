...
# Disable tools that cause libtool _spawnv issues on Windows
LIST(APPEND _pcre2_configure_args "--disable-pcre2grep")
LIST(APPEND _pcre2_configure_args "--disable-pcre2test")

IF(CMAKE_BUILD_TYPE MATCHES "^Debug$")
  LIST(APPEND _pcre2_configure_args "--enable-debug")
ENDIF()

# Windows-specific configure options to avoid libtool issues
IF(RV_TARGET_WINDOWS)
  # Disable additional components that might cause libtool wrapper issues
  LIST(APPEND _pcre2_configure_args "--disable-pcre2-16")
  LIST(APPEND _pcre2_configure_args "--disable-pcre2-32")
  LIST(APPEND _pcre2_configure_args "--disable-cpp")
  LIST(APPEND _pcre2_configure_args "--disable-coverage")
ENDIF()
