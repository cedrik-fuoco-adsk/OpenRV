...
ELSE()
  # Some package managers derive the DLL name from the component name ("jpeg") but the actual DLL is
  # "jpeg62.dll". The name mismatch causes IMPORTED_LOCATION to fall back to jpeg.lib (import library)
  # instead of the DLL. BIN_DIR copies the entire bin/ directory, ensuring jpeg62.dll reaches
  # RV_STAGE_BIN_DIR regardless of IMPORTED_LOCATION resolution.
