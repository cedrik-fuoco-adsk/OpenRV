...
# Set bool variables based on RV_VFX_PLATFORM
SET(RV_VFX_PLATFORM_2023 FALSE CACHE BOOL "VFX CY2023 platform" FORCE)
SET(RV_VFX_PLATFORM_2024 FALSE CACHE BOOL "VFX CY2024 platform" FORCE)

IF("${RV_VFX_PLATFORM}" STREQUAL "CY2023")
  SET(RV_VFX_PLATFORM_CY2023 TRUE CACHE BOOL "VFX CY2023 platform" FORCE)
ELSEIF("${RV_VFX_PLATFORM}" STREQUAL "CY2024")
  SET(RV_VFX_PLATFORM_CY2024 TRUE CACHE BOOL "VFX CY2024 platform" FORCE)
ENDIF()