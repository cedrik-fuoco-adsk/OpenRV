...
MACRO(after_copy_platform FILE_PATH SUB_FILE_PATH FILES_TO_FIX_RPATH)
  IF(NOT IS_SYMLINK ${FILE_PATH})
    GET_FILENAME_COMPONENT(FILE_EXT ${SUB_FILE_PATH} LAST_EXT)
    IF(NOT FILE_EXT IN_LIST KNOWN_EXTENSIONS_TO_SKIP)
      LIST(APPEND FILES_TO_FIX_RPATH "${SUB_FILE_PATH}\n")
    ENDIF()
  ELSE()
    MESSAGE(STATUS "\tSkipping RPATH cleanup on symlinks ${SUB_FILE_PATH}")
  ENDIF()
ENDMACRO()
...
MACRO(post_install_platform)
  ...
  MESSAGE(STATUS "python3 ${CMAKE_CURRENT_LIST_DIR}/../../src/build/remove_absolute_rpath.py --files-list ${_output_file_to_fix_} --root ${CMAKE_INSTALL_PREFIX}")
  EXECUTE_PROCESS(
