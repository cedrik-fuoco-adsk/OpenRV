...
FUNCTION(before_copy FILE_PATH RET_VAL)
  FOREACH(
    ...
    MESSAGE(STATUS "Checking '${FILE_PATH_LOWER}' for '${QT_DO_NOT_INSTALL_COMPONENT}'")
...
MACRO(after_copy FILE_PATH SUB_FILE_PATH FILES_TO_FIX_RPATH)
  IF(COMMAND after_copy_platform)
    AFTER_COPY_PLATFORM(${FILE_PATH} ${SUB_FILE_PATH} ${FILES_TO_FIX_RPATH})
  ENDIF()
ENDMACRO()
