...
public:
    ...
    // Useful for testing a pattern without the overhead of creating a full Match object
...
//******************************************************************************
// GlobEx class. Transparent wrapper around RegEx that uses shell glob syntax.
