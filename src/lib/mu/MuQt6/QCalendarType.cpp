...
QCalendarType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QCalendarType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QCalendarType::finalizer, 0, 0, 0);
}

void 
QCalendarType::finalizer (void* obj, void* data)
{
...
bool qt_QCalendar_isDateValid_bool_QCalendar_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_year, int param_month, int param_day)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QCalendar arg0 = getqtype<QCalendarType>(param_this);
    int arg1 = (int)(param_year);
...
{
    NODE_RETURN(qt_QCalendar_isDateValid_bool_QCalendar_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, int)));
}
...
addSymbols(
    new Alias(c, "System", "int"),
      new SymbolicConstant(c, "Gregorian", "int", Value(int(QCalendar::System::Gregorian))),
      ...
      new SymbolicConstant(c, "IslamicCivil", "int", Value(int(QCalendar::System::IslamicCivil))),
    EndArguments);

addSymbols(
    // enums
    // member functions
    new Function(c, "QCalendar", _n_QCalendar0, None, Compiled, qt_QCalendar_QCalendar_QCalendar_QCalendar, Return, "qt.QCalendar", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "QCalendar", _n_QCalendar1, None, Compiled, qt_QCalendar_QCalendar_QCalendar_QCalendar_int, Return, "qt.QCalendar", Parameters, new Param(c, "this", "qt.QCalendar"), new Param(c, "system", "int"), End),
    // MISSING: QCalendar (QCalendar; QCalendar this, "QAnyStringView" name)
    // MISSING: QCalendar (QCalendar; QCalendar this, flags QCalendar::SystemId id)
    // MISSING: dateTimeToString (string; QCalendar this, "QStringView" format, QDateTime datetime, QDate dateOnly, QTime timeOnly, "const QLocale &" locale)
    new Function(c, "dayOfWeek", _n_dayOfWeek0, None, Compiled, qt_QCalendar_dayOfWeek_int_QCalendar_QDate, Return, "int", Parameters, new Param(c, "this", "qt.QCalendar"), new Param(c, "date", "qt.QDate"), End),
    new Function(c, "daysInYear", _n_daysInYear0, None, Compiled, qt_QCalendar_daysInYear_int_QCalendar_int, Return, "int", Parameters, new Param(c, "this", "qt.QCalendar"), new Param(c, "year", "int"), End),
    new Function(c, "hasYearZero", _n_hasYearZero0, None, Compiled, qt_QCalendar_hasYearZero_bool_QCalendar, Return, "bool", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "isDateValid", _n_isDateValid0, None, Compiled, qt_QCalendar_isDateValid_bool_QCalendar_int_int_int, Return, "bool", Parameters, new Param(c, "this", "qt.QCalendar"), new Param(c, "year", "int"), new Param(c, "month", "int"), new Param(c, "day", "int"), End),
    new Function(c, "isGregorian", _n_isGregorian0, None, Compiled, qt_QCalendar_isGregorian_bool_QCalendar, Return, "bool", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "isLeapYear", _n_isLeapYear0, None, Compiled, qt_QCalendar_isLeapYear_bool_QCalendar_int, Return, "bool", Parameters, new Param(c, "this", "qt.QCalendar"), new Param(c, "year", "int"), End),
    new Function(c, "isLunar", _n_isLunar0, None, Compiled, qt_QCalendar_isLunar_bool_QCalendar, Return, "bool", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "isLuniSolar", _n_isLuniSolar0, None, Compiled, qt_QCalendar_isLuniSolar_bool_QCalendar, Return, "bool", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "isProleptic", _n_isProleptic0, None, Compiled, qt_QCalendar_isProleptic_bool_QCalendar, Return, "bool", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "isSolar", _n_isSolar0, None, Compiled, qt_QCalendar_isSolar_bool_QCalendar, Return, "bool", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "isValid", _n_isValid0, None, Compiled, qt_QCalendar_isValid_bool_QCalendar, Return, "bool", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "maximumDaysInMonth", _n_maximumDaysInMonth0, None, Compiled, qt_QCalendar_maximumDaysInMonth_int_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "maximumMonthsInYear", _n_maximumMonthsInYear0, None, Compiled, qt_QCalendar_maximumMonthsInYear_int_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    new Function(c, "minimumDaysInMonth", _n_minimumDaysInMonth0, None, Compiled, qt_QCalendar_minimumDaysInMonth_int_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    // MISSING: monthName (string; QCalendar this, "const QLocale &" locale, int month, int year, flags QLocale::FormatType format)
    new Function(c, "monthsInYear", _n_monthsInYear0, None, Compiled, qt_QCalendar_monthsInYear_int_QCalendar_int, Return, "int", Parameters, new Param(c, "this", "qt.QCalendar"), new Param(c, "year", "int"), End),
    new Function(c, "name", _n_name0, None, Compiled, qt_QCalendar_name_string_QCalendar, Return, "string", Parameters, new Param(c, "this", "qt.QCalendar"), End),
    // MISSING: standaloneMonthName (string; QCalendar this, "const QLocale &" locale, int month, int year, flags QLocale::FormatType format)
    // MISSING: standaloneWeekDayName (string; QCalendar this, "const QLocale &" locale, int day, flags QLocale::FormatType format)
    // MISSING: weekDayName (string; QCalendar this, "const QLocale &" locale, int day, flags QLocale::FormatType format)
    // static functions
    new Function(c, "availableCalendars", _n_availableCalendars0, None, Compiled, qt_QCalendar_availableCalendars_stringBSB_ESB_, Return, "string[]", End),
    EndArguments);
