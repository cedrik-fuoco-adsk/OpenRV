...
{
    QCalendarType* t_QCalendar = new QCalendarType(c, "QCalendar"); qt->addSymbol(t_QCalendar);
    ...
    QTimeZoneType* t_QTimeZone = new QTimeZoneType(c, "QTimeZone"); qt->addSymbol(t_QTimeZone);
