...
bool qt_QDate_setDate_bool_QDate_int_int_int_QCalendar(Mu::Thread& NODE_THREAD, Pointer param_this, int param_year, int param_month, int param_day, Pointer param_cal)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QDate arg0 = getqtype<QDateType>(param_this);
    int arg1 = (int)(param_year);
...
Pointer qt_QDate_toString_string_QDate_string_QCalendar(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_format, Pointer param_cal)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QDate arg0 = getqtype<QDateType>(param_this);
...
Pointer qt_QDate_fromString_QDate_string_string_QCalendar(Mu::Thread& NODE_THREAD, Pointer param_string, Pointer param_format, Pointer param_cal)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QString  arg0 = qstring(param_string);
    const QString  arg1 = qstring(param_format);
...
{
    NODE_RETURN(qt_QDate_addMonths_QDate_QDate_int_QCalendar(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer)));
}
...
{
    NODE_RETURN(qt_QDate_addYears_QDate_QDate_int_QCalendar(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer)));
}
...
{
    NODE_RETURN(qt_QDate_setDate_bool_QDate_int_int_int_QCalendar(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, Pointer)));
}
...
{
    NODE_RETURN(qt_QDate_toString_string_QDate_string_QCalendar(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
{
    NODE_RETURN(qt_QDate_fromString_QDate_string_string_QCalendar(NODE_THREAD, NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
addSymbols(
    ...
    new Function(c, "addMonths", _n_addMonths0, None, Compiled, qt_QDate_addMonths_QDate_QDate_int_QCalendar, Return, "qt.QDate", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "nmonths", "int"), new Param(c, "cal", "qt.QCalendar"), End),
    new Function(c, "addMonths", _n_addMonths1, None, Compiled, qt_QDate_addMonths_QDate_QDate_int, Return, "qt.QDate", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "nmonths", "int"), End),
    new Function(c, "addYears", _n_addYears0, None, Compiled, qt_QDate_addYears_QDate_QDate_int_QCalendar, Return, "qt.QDate", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "nyears", "int"), new Param(c, "cal", "qt.QCalendar"), End),
    new Function(c, "addYears", _n_addYears1, None, Compiled, qt_QDate_addYears_QDate_QDate_int, Return, "qt.QDate", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "nyears", "int"), End),
    new Function(c, "day", _n_day0, None, Compiled, qt_QDate_day_int_QDate_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "cal", "qt.QCalendar"), End),
    new Function(c, "day", _n_day1, None, Compiled, qt_QDate_day_int_QDate, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), End),
    new Function(c, "dayOfWeek", _n_dayOfWeek0, None, Compiled, qt_QDate_dayOfWeek_int_QDate_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "cal", "qt.QCalendar"), End),
    new Function(c, "dayOfWeek", _n_dayOfWeek1, None, Compiled, qt_QDate_dayOfWeek_int_QDate, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), End),
    new Function(c, "dayOfYear", _n_dayOfYear0, None, Compiled, qt_QDate_dayOfYear_int_QDate_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "cal", "qt.QCalendar"), End),
    new Function(c, "dayOfYear", _n_dayOfYear1, None, Compiled, qt_QDate_dayOfYear_int_QDate, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), End),
    new Function(c, "daysInMonth", _n_daysInMonth0, None, Compiled, qt_QDate_daysInMonth_int_QDate_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "cal", "qt.QCalendar"), End),
    new Function(c, "daysInMonth", _n_daysInMonth1, None, Compiled, qt_QDate_daysInMonth_int_QDate, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), End),
    new Function(c, "daysInYear", _n_daysInYear0, None, Compiled, qt_QDate_daysInYear_int_QDate_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "cal", "qt.QCalendar"), End),
    ...
    new Function(c, "month", _n_month0, None, Compiled, qt_QDate_month_int_QDate_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "cal", "qt.QCalendar"), End),
    ...
    new Function(c, "setDate", _n_setDate1, None, Compiled, qt_QDate_setDate_bool_QDate_int_int_int_QCalendar, Return, "bool", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "year", "int"), new Param(c, "month", "int"), new Param(c, "day", "int"), new Param(c, "cal", "qt.QCalendar"), End),
    ...
    new Function(c, "toString", _n_toString0, None, Compiled, qt_QDate_toString_string_QDate_string_QCalendar, Return, "string", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "format", "string"), new Param(c, "cal", "qt.QCalendar"), End),
    ...
    // MISSING: toString (string; QDate this, "QStringView" format, QCalendar cal)
    // MISSING: weekNumber (int; QDate this, "int *" yearNumber)
    new Function(c, "year", _n_year0, None, Compiled, qt_QDate_year_int_QDate_QCalendar, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "cal", "qt.QCalendar"), End),
    new Function(c, "year", _n_year1, None, Compiled, qt_QDate_year_int_QDate, Return, "int", Parameters, new Param(c, "this", "qt.QDate"), End),
    // static functions
    ...
    // MISSING: fromString (QDate; "QStringView" string, flags Qt::DateFormat format)
    // MISSING: fromString (QDate; "QStringView" string, "QStringView" format, QCalendar cal)
    // MISSING: fromString (QDate; string string, "QStringView" format, QCalendar cal)
    new Function(c, "fromString", _n_fromString4, None, Compiled, qt_QDate_fromString_QDate_string_string_QCalendar, Return, "qt.QDate", Parameters, new Param(c, "string", "string"), new Param(c, "format", "string"), new Param(c, "cal", "qt.QCalendar"), End),
