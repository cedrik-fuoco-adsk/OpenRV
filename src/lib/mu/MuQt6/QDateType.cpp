...
addSymbols(
    ...
    // MISSING: addMonths (QDate; QDate this, int nmonths, "QCalendar" cal)
    ...
    // MISSING: addYears (QDate; QDate this, int nyears, "QCalendar" cal)
    ...
    // MISSING: dayOfYear (int; QDate this, "QCalendar" cal)
    ...
    // MISSING: daysInMonth (int; QDate this, "QCalendar" cal)
    ...
    // MISSING: month (int; QDate this, "QCalendar" cal)
    ...
    // MISSING: year (int; QDate this, "QCalendar" cal)
    ...
    // MISSING: fromString (QDate; string string, string format, "QCalendar" cal)
