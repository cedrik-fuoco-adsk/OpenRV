...
BasicGLProgram::BasicGLProgram(const std::string& vertexcode, const std::string& fragmentcode)
                : m_vertexCode(vertexcode), m_fragmentCode(fragmentcode)
{
    m_identifier = vertexcode + fragmentcode;   
}
BasicGLProgram::~BasicGLProgram()
{
    uninstall(); 
}
...
//------------------------public functions-----------------------------------
const char* 
BasicGLProgram::identifier() const
{
    return m_identifier.c_str();
}

const BasicGLProgram* 
BasicGLProgram::select(const std::string& vertexcode, const std::string& fragmentcode)
{
...
const GLProgram*
basicGLProgram(const char* vertexShader, const char* fragShader)
{
...
{
    return basicGLProgram(DirectionPaintVertex_glsl, DirectionPaintFrag_glsl);
}

const GLProgram* softDirectionPaintGLProgram()
{
    return basicGLProgram(DirectionPaintVertex_glsl, SoftDirectionPaintFrag_glsl);
}
