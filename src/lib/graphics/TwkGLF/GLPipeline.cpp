...
void 
GLPipeline::setProjection(const Mat44f &p)
{
...
void 
GLPipeline::setModelview(const Mat44f &m)
{
    // only change gl state if necessary
...
void 
GLPipeline::setViewport(const int x, const int y, const int w, const int h)
{
    // only change gl state if necessary
...
void 
GLPipeline::useCurrentProjectionGL2() const
{
...
void
GLPipeline::useCurrentModelviewGL2() const
{
...
//
void 
GLPipeline::setUniformFloat(const char* name, size_t no, GLfloat* data)
{
#ifdef NDEBUG
    try 
    {
...
void 
GLPipeline::setUniformInt(const char* name, size_t no, GLint* data)
{
#ifdef NDEBUG
    try
    {
...
void 
GLPipeline::setUniformMatrix(const char* name, TwkMath::Mat44f& data)
{
#ifdef NDEBUG
    try
    {
...
//----------------------------------------------------------------------
//
// get GL uniforms, these functions are very expensive. should call only when necessary
//
void 
GLPipeline::uniformFloat(const char* name, GLfloat* data) const
{
#ifdef NDEBUG
    try
    {
...
void
GLPipeline::uniformInt(const char* name, GLint* data) const
{
#ifdef NDEBUG
    try
    {
...
void
GLPipeline::uniformMatrix(const char* name, GLfloat* data) const
{
#ifdef NDEBUG
    try
    {
...
//
Mat44f
GLPipeline::currentProjection() const
{
    return m_projection;
}

Mat44f 
GLPipeline::currentModelview() const
{
    return m_modelView;
}

void
GLPipeline::currentViewport(float (&v)[4]) const
{
...
bool
GLPipeline::uniformIsValid(const string& name) const
{
