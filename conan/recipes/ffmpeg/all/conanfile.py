...
class FFMpegConan(ConanFile):
    ...
    # OpenRV: Added None value to options. None means that the option will use the default
    #         value of ffmpeg configure script. The option won't be added to the command.
    options = {
        "shared": [True, False, None],
        "fPIC": [True, False, None],
        "avdevice": [True, False, None],
        "avcodec": [True, False, None],
        "avformat": [True, False, None],
        "swresample": [True, False, None],
        "swscale": [True, False, None],
        "postproc": [True, False, None],
        "avfilter": [True, False, None],
        "with_asm": [True, False, None],
        "with_zlib": [True, False, None],
        "with_bzip2": [True, False, None],
        "with_lzma": [True, False, None],
        "with_libiconv": [True, False, None],
        "with_freetype": [True, False, None],
        "with_openjpeg": [True, False, None],
        "with_openh264": [True, False, None],
        "with_opus": [True, False, None],
        "with_vorbis": [True, False, None],
        "with_zeromq": [True, False, None],
        "with_sdl": [True, False, None],
        "with_libx264": [True, False, None],
        "with_libx265": [True, False, None],
        "with_libvpx": [True, False, None],
        "with_libmp3lame": [True, False, None],
        "with_libfdk_aac": [True, False, None],
        "with_libwebp": [True, False, None],
        "with_libdav1d": [True, False, None],
        "with_ssl": [False, "openssl", "securetransport"],
        "with_libalsa": [True, False, None],
        "with_pulse": [True, False, None],
        "with_vaapi": [True, False, None],
        "with_vdpau": [True, False, None],
        "with_vulkan": [True, False, None],
        "with_xcb": [True, False, None],
        "with_appkit": [True, False, None],
        "with_avfoundation": [True, False, None],
        "with_coreimage": [True, False, None],
        "with_audiotoolbox": [True, False, None],
        "with_videotoolbox": [True, False, None],
        "with_programs": [True, False],
        # OpenRV: Added large-tests
        "with_large_tests": [True, False],
        # OpenRV: Added outdevs
        "with_outdevs": [True, False],
        # OpenRV: doc
        "with_doc": [True, False],
    ...
    # OpenRV: Overwrite the default in the recipe directly because OpenRV is using a
    #         local recipe for now. Once a "Conan server" is up, it can be reverted.
    #         A initial "conan create" needs to be called to put the custom recipe in the
    #         local cache.
    default_options = {
        "shared": False,
        "fPIC": True,
        ...
        "with_libx265": None,
        "with_libvpx": None,
        "with_libmp3lame": None,
        "with_libfdk_aac": None,
        "with_libwebp": None,
        "with_libdav1d": True,
        "with_ssl": "openssl",
        "with_libalsa": None,
        ...
        "with_xcb": None,
        "with_appkit": None,
        "with_avfoundation": None,
        "with_coreimage": None,
        "with_audiotoolbox": None,
        "with_videotoolbox": None,
        "with_programs": False,
        ...
        for dependency, features in self._dependencies.items():
            ...
            if not used:
                raise ConanInvalidConfiguration(
                    "FFmpeg '{}' option requires '{}' option to be enabled".format(dependency, "' or '".join(features))
                )
    ...
    def _patch_sources(self):
        ...
        if self.options.with_ssl == "openssl":
            ...
            openssl_libraries = " ".join([f"-l{lib}" for lib in cpp_info.libs + cpp_info.system_libs])
    ...
    def generate(self):
        ...
        args.extend(
            self._split_and_format_options_string("disable-hwaccel", self.options.disable_hardware_accelerators)
        )
        ...
        if not self.options.with_large_tests:
            args.append("--disable-large-tests")
        if not self.options.with_outdevs:
            args.append("--disable-outdevs")
        if not self.options.with_doc:
    ...
    def package(self):
        ...
        autotools = Autotools(self)
        autotools.install()
        # OpenRV keep the pkgconfig files
    ...
    def package_info(self):
        ...
        if self.options.avcodec:
            ...
            # OpenRV
            if self.options.with_libdav1d:
                self.cpp_info.components["avcodec"].requires.append("dav1d::dav1d")
            if self.options.get_safe("with_audiotoolbox"):
