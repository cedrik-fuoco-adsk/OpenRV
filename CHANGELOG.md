...
- Fixing MacOS build with CMake 3.26 (#105) ([#105](https://github.com/AcademySoftwareFoundation/OpenRV/pull/105))

### 120

- Fix gltext memory leak (and other mem leaks) (#166) ([#166](https://github.com/AcademySoftwareFoundation/OpenRV/pull/166))

### 288

- Fix FFmpeg being always rebuilt after rvcfg (#290) ([#290](https://github.com/AcademySoftwareFoundation/OpenRV/pull/290))

### Cmake

- add Qt5 `resources` and `translations` folder variables (#8) ([#8](https://github.com/AcademySoftwareFoundation/OpenRV/pull/8))

### Issue-169

- [Bug]: OpenRV fails to rebuild on Windows (#174) ([#174](https://github.com/AcademySoftwareFoundation/OpenRV/pull/174))

### MacOS

- Fix path to shared libraries from binary dependency list on install (#314) ([#314](https://github.com/AcademySoftwareFoundation/OpenRV/pull/314))

### OpenSSL

- Re-enable assembly language routines (#150) ([#150](https://github.com/AcademySoftwareFoundation/OpenRV/pull/150))

### SG-29809

- Fix unable to write RV settings on Windows (#55) ([#55](https://github.com/AcademySoftwareFoundation/OpenRV/pull/55))

### Thread.cpp

- change ucontext to ucontext_t (#14) ([#14](https://github.com/AcademySoftwareFoundation/OpenRV/pull/14))

### VFX2023

- Updating the documentation (#308) ([#308](https://github.com/AcademySoftwareFoundation/OpenRV/pull/308))

### [116

- Fix segfault in httpGet command] (#117) ([#117](https://github.com/AcademySoftwareFoundation/OpenRV/pull/117))
